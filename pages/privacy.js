...
function privacy() {
  return (
    <PrivacyPolicy>
      ...
      <p>We use the information we collect from you to provide and improve our services, such as responding to your requests for information.</p>
      <h3>Sharing of Your Information</h3>
      <p>We may share your personal information with third parties for the following purposes:

To complete a transaction or fulfill a service requested by you, such as connecting you with a real estate professional.
To comply with legal obligations, such as responding to a subpoena or court order.
To protect the rights and safety of vannbuyshouses.com, our users, and the public.
We may also share anonymous or aggregated data with third parties for research or marketing purposes.</p>
      <h3>Security of Your Information</h3>
      <p>We take reasonable precautions to protect your personal information from loss, misuse, and unauthorized access, disclosure, alteration, or destruction. However, no internet transmission is completely secure, and we cannot guarantee the security of your information.</p>
